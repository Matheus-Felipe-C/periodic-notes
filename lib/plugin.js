...
const plugin = {
  ...
  appOption: {
    ...
    "Open weekly note": async function (app) {
      ...
      const newNoteUuid = await createNoteFromTemplate(app, weeklyTemplate, plugin.constants.tagsToExclude);
    ...
    "Open monthly note": async function (app) {
      ...
      const newNoteUuid = await createNoteFromTemplate(app, monthlyTemplate, plugin.constants.tagsToExclude);
    ...
    "Open quartely note": async function (app) {
      ...
      const newNoteUuid = await createNoteFromTemplate(app, quartelyTemplate, plugin.constants.tagsToExclude);
    ...
    "Open yearly note": async function (app) {
      ...
      const newNoteUuid = await createNoteFromTemplate(app, yearlyTemplate, plugin.constants.tagsToExclude);
